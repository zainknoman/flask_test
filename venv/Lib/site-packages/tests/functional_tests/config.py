...
INCLUDE_PROVIDERS = [
    # OAuth 1.0a  - This mostly deprecated ias a service 'in the wild' - we should drop support.
    # 'bitbucket',
    # 'flickr',
    # 'plurk',
     'twitter',
    ...
    # 'behance',  # doesn't support third party authorization anymore.facebook
...
PROVIDERS = {
    ...
    # OAuth 2.0
    'facebook': {
        'consumer_key': '2371393686287481',
        'consumer_secret': '08d7d6296579c657bc68135956d3a8c4',
        'user_id': '108615837019159',
        'user_login': "authomatic_esvucys_testuser@tfbnw.net",
